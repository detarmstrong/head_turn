...
(function(process) {
 ...
 while (null !== k);
    ...
    var Bf = function(a) {
      function b(b, c) {
        this.source = b, this.controller = new Hg, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, a.call(this);
      }
    ...
    var Cf = function(b) {
      function c(a, c) {
        this.source = a, this.controller = new Hg, c && c.subscribe ? this.pauser = this.controller.merge(c) : this.pauser = this.controller, b.call(this);
      }
    ...
    var Ff = function(a) {
      ...
      var d = function(a) {
        ...
        return ac(c, a), c.prototype.completed = function() {
          this.observer.onCompleted(), this.dispose();
        }, c.prototype.error = function(a) {
          this.observer.onError(a), this.dispose();
        }, c.prototype.next = function(a) {
          this.observer.onNext(a), this.scheduleDisposable = Hc.schedule(this, d);
        }, b.dispose = function() {
